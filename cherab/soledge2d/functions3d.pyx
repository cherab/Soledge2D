...
from cherab.core.math cimport AxisymmetricMapper
from cherab.core.math cimport VectorFunction3D

cdef double RAD_TO_DEG = 360 / (2*M_PI)


cdef class SOLEDGE2DFunction3D(Function3D):
    ...
    cdef double evaluate(self, double x, double y, double z) except? -1e999:
        ...
        cdef:
            ...
            int ix  # grid x coordinate
            int iy  # grid y coordinate
...
cdef class SOLEDGE2DVectorFunction3D(VectorFunction3D):
